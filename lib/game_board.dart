...
import 'package:simple_chess/components/dead_piece.dart';
import 'package:simple_chess/components/piece.dart';
import 'package:simple_chess/components/square.dart';
import 'package:simple_chess/helper/helper_methods.dart';
import 'package:simple_chess/values/colors.dart';
  ...
  bool isKingInCheck(bool isWhiteKing) {
    ...
    for (int i = 0; i < 8; i++) {
      for (int j = 0; j < 8; j++) {
        ...
        // check if the king's position is this piece's valid moves
